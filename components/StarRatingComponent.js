...
class StarRatingComponent extends Component {
  ...
  renderIcon(index, value, name, id) {
    const { renderStarIcon, renderStarIconHalf, renderEmptyStarIcon = (nextValue, prevValue, name) => <Icon icon="solar:star-broken" />  } = this.props;
    ...
    if (typeof renderEmptyStarIcon === 'function') {
