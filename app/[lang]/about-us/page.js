  ...
  return (
    <main className="flex min-h-screen flex-col items-center space-y-4 py-24">
      <div className={'max-w-screen-xl w-full px-[10px] flex flex-col space-y-8'}>
        ...
        <div>
          Apk Store.com is a website providing smartphones software downloads founded in 2014 by Apk Store Team, and has
        ...
        <div>
          ...
          Apk Store team is always ready to help all users solve their problems about smartphones app installing, update
          and more.
        </div>
        <div className={'text-black font-bold tracking-wide text-2xl'}>Important Notice</div>
        <div>
          Apk Store.com is NOT associated or affiliated with Google, Google Play or Android in any way. Android is a
          trademark of Google Inc. All the apps & games are property and trademark of their respective developer or
          publisher and for HOME or PERSONAL use ONLY. Please be aware that apkstore.com ONLY SHARE THE ORIGINAL APK FILE
